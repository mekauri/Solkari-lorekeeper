                        ...
                        <div class="container mt-2">
                            ...
                            @foreach ($pet->variants as $variant)
                                <div class="row world-entry p-2">
                                    @if ($variant->imageurl)
                                        <div class="col-md-3 world-entry-image"><a href="{{ $variant->imageurl }}" data-lightbox="entry" data-title="{{ $variant->variant_name }}"><img src="{{ $variant->imageurl }}" class="world-entry-image"

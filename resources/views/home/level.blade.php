...
@section('home-content')
    ...
    <div class="container text-center">
        ...
        @if ($next)
            ...
            <div class="progress">
                <div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="{{ $user->level->current_exp }}" aria-valuemin="0" aria-valuemax="{{ $next->exp_required }}" style="width:{{ $width }}%">
                    {{ $user->level->current_exp }}/{{ $next->exp_required }}
                </div>
            </div>

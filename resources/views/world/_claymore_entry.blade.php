                    ...
                    <div class="col-6">
                        ...
                        <div class="row">
                            @if ($item->parent_id && $item->parent)
                                <div class="col-md">
                                    {!! $item->parent->displayName !!} @if ($item->cost && $item->currency_id <= 0) <small>(Upgrade costs {{ $item->cost }} @if ($item->currency_id != 0)
                                                <img src="{!! $item->currency->iconurl !!}">{!! $item->currency->displayName !!}.)</small>
